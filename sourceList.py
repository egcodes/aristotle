...
def createNewsSourceByPresent(present):
		...
		newsSources = {
				'gundem':	[
									...
									('hurriyet.com.tr', 'http://www.hurriyet.com.tr', ('-',), (), ({'col-md-7 text-right':todayPointFormat},)),
									...
									('posta.com.tr', 'http://www.posta.com.tr', ('-haberi',), ('futbol','Fenerbahce', 'Galatasaray', 'Besiktas', 'Trabzonspor', 'fenerbahce', 'besiktas', 'galatasaray', 'trabzonspor'), ({'news-specs':todayTrFormat},), {'-':1},),										
				...
				'teknoloji':	[
									...
									('teknolojioku.com', 'http://www.teknolojioku.com', ('/haber/',), (),({'time':todayTrNonZeroFormat},) ),
				...
				'kulturvesanat':
								[
									('haberturk.com','http://www.haberturk.com/kultur-sanat', ('/kultur-sanat/',), (), ({'date':todayTrFormat},), {'|':1}),
									('hurriyet.com.tr', 'http://www.hurriyet.com.tr/keyif', ('-',), (), ({'date FR':todayPointFormat},)),
