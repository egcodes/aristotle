...
def createNewsSourceByPresent(present):
		...
		newsSources = {
				'gundem':	[
								 ...
								 ('sozcu.com.tr', 'http://www.sozcu.com.tr', ('/gundem/', '/gunun-icinden/', '/dunya/', '/ekonomi/', '/egitim/', '/saglik/',), ('spor_', 'video.', ), ({'date-row':todayTrFormatSpecial2},)),
								 ...
								 ('hurriyet.com.tr', 'http://www.hurriyet.com.tr', ('-',), (), ({'row news-detail-info':todayTrFormat},)),
								 ...
								 ('haber.sol.org.tr', 'http://haber.sol.org.tr', ('/turkiye/','/emek-sermaye/', '/dunya/', '/toplum/', '/medya/',), (), ({'date-display-single':todayTrFormat},), {'|':2},),
								 ...
								 ('internethaber.com', 'http://www.internethaber.com', ('.htm',), ('gazeteoku.com', 'otomobil.internethaber.com', 'spor.', ), ({'pubdate':'%s'%todayLineFormat},)),
								 ...
								 ('samanyoluhaber.com', 'http://www.samanyoluhaber.com', ('-',), ('fenerbahce', 'besiktas', 'galatasaray',), ({'wrap':todayTrShortFormat},)),
								 ...
								 ('yeniakit.com.tr', 'http://www.yeniakit.com.tr', ('/haber/',), (), ({"news_analysis":todayTrFormat},)),	
								 ('takvim.com.tr', 'http://www.takvim.com.tr', (today,), ('/Yazarlar/','/spor/', '/Spor/', '/Televizyon', '/multimedya/', '/Saklambac/', '/saklambac/'), (1),),
								 ...
								 ('diken.com.tr', 'http://www.diken.com.tr', ('-',), ('/kategori/', 'bu-gazete/', '-ekim-', '-kasim-', '-aralik-', '-ocak-', '-subat-', '-mart-', '-nisan-', '-mayis-', '-haziran-', '-temmuz-', '-agustos-', '-eylul-',), ({'entry-meta':todaySlashFormat},)),
				...
				'koseyazilari': [
								 ...
								 ('gazetevatan.com', 'http://www.gazetevatan.com/yazarlar/', ('-yazar-yazisi-',), (), ({'cdate':todayTrFormat},{'datesrc':todayTrFormat},), {'|':1}),
