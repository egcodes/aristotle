...
def createNewsSourceByPresent(present):
		...
		newsSources = {
				'gundem':	[
									...
									('yeniakit.com.tr', 'http://www.yeniakit.com.tr/gundem', ('/haber/',), ('futbol','Fenerbahçe', 'Galatasaray', 'Beşiktaş', 'Trabzonspor', 'fenerbahçe', 'beşiktaş', 'galatasaray', 'trabzonspor'), ({"date":todayTrFormat},)),	
				...
				'kulturvesanat':
								[
									('haberturk.com','http://www.haberturk.com/kultur-sanat', ('/kultur-sanat/',), (), ({'articles-date':todayTrFormat},), {'|':1}),
